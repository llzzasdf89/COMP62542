...
class Course extends Component{
    ...
    constructor(props){
        ...
        const manCourse = courses.filter((course)=>course.type==='Mandatory')
        const optCourse = courses.filter((course)=> course.type ==='Optional')
        const optCoursesAvailable = courses.filter((course) => course.type==='Optional Available' )
        this.state = {
            student,
            manCourse,
            optCourse,
